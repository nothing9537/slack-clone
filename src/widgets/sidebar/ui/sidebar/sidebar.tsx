...
export const Sidebar: FC = memo(() => {
  ...
  return (
    <aside className="w-[4.5rem] h-full bg-[#481349] flex flex-col gap-y-4 items-center pt-2 pb-1 overflow-auto app-scrollbar">
      ...
      <SidebarButton Icon={MessageSquare} label="DM's" isActive={false} disabled />
      <SidebarButton Icon={Bell} label="Activity" isActive={false} disabled />
      <SidebarButton Icon={MoreHorizontal} label="More" isActive={false} disabled />
